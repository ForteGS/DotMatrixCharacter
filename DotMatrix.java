 ...
 * respective Dot Matrix representations. It reads a text file that contains the
 * dot matrix representations of all characters and creates a TreeMap. The key
 * of every map element stores a single character and the value of the map
 * element is a List<String> that stores the dot matrix representation of the
 * key.
 * 
 * @author CS 367 TA
 */
...
public class DotMatrix {
	...
	/*
	 * dm will store the mapping between characters and their dot matrix
	 * representations
	 */
	...
	/*
	 * The loadAlphabets method takes a text file name as parameter. The first
	 * line of the text file contains the characters that we will use to create
	 * the message loop. The remainder of the text file contains the dot matrix
	 * representations of the characters in the same order as they appear in the
	...
	/*
	 * The getDotMatrix method takes as parameter a single character and returns
	 * a list of strings that stores the dot matrix representation of the
	 * character.
	 */
	...
	public boolean isValidCharacter(String s) {
		return (characters.toUpperCase().contains(s.toUpperCase()) || s
				.equals(" "));
	}
